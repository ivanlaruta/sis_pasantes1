...
<table border="0">
			<tr>
				<td colspan="2">
					<center><h3>Menú Control Pasantes</h3></center>
				</td>
			</tr>
			<tr>
				<td height="60">
					<a href="<?php echo base_url(); ?>index.php/registroPasante" class="btn btn-primary" style='width:170px'>Registrar</a>
				</td>
			...
			<tr>
				<td height="60"><a href="" class="btn btn-primary" style='width:170px'>Registro de Tareas </a> </td> 
